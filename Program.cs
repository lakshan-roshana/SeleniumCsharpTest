...
namespace SauceBot
{
    class Program
    {
        ...
        static void checkPrice(IWebDriver driver, WebDriverWait wait)
            {
        ...
        static void AddtoCart(IWebDriver driver, WebDriverWait wait)
            {
        ...
        static void logout(IWebDriver driver, WebDriverWait wait)
            {
